...
names <- c("None Selected",  "Annika",
       "Lukas", "Marijn", "Manika", "Michael", "Zarine")
...
ui_intro <- sidebarLayout(
    ...
    mainPanel(
        ...
        actionButton("new_video", "Show a New YouTube Video") 
    )
)
...
server <- function(input, output, session) {
    ...
    to_code <- eventReactive(input$new_video, {
    ...
    # When "Show Video" button is clicked again, display clean form ------
